    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && DeckManager === void 0 ? (_reportPossibleCrUseOfDeckManager({
        ...
        playerSplit() {
          ...
          console.log('After splitting: ' + this.players.length);
          this.players.forEach(player => {
            console.log('After splitting: ' + player.getName());
          });
        }
...
//# sourceMappingURL=9024f246577476d781952723814f7b28f4e136a3.js.map