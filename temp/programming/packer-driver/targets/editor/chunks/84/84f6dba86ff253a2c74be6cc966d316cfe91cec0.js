      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && DeckManager === void 0 ? (_reportPossibleCrUseOfDeckManager({
        ...
        playerHit() {
          ...
          if (cardData) {
            ...
            console.log('Player hits and receives:', cardData);
            console.log('Player Hand now:', this.player.getHand());
            console.log('Player Hand total:', this.player.getHandValue());
          }
        }
...
//# sourceMappingURL=84f6dba86ff253a2c74be6cc966d316cfe91cec0.js.map