  ...
  return {
    ...
    execute: function () {
      ...
      _export("DeckManager", DeckManager = (_dec = ccclass('DeckManager'), _dec(_class = class DeckManager extends Component {
        ...
        loadSprites() {
          resources.load('sprites/Cards/back01/spriteFrame', SpriteFrame, (err, spriteFrame) => {
            if (err) {
              console.error('Failed to load back sprite:', err);
            } else {
...
//# sourceMappingURL=cafac1540a89d2beff8d5fa952e2bed8a3b2e3c2.js.map