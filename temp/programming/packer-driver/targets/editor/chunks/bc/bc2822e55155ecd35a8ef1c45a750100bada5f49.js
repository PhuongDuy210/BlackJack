    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        async addCardToParticipant(participant) {
          ...
          const cardsToDeal = hand.slice(handArea.children.length); // for (let i = handArea.children.length; i < hand.length; i++) {
          //     await this.animateCardToHand(participant, handArea);
          // }

          const animations = cardsToDeal.map(card => this.animateCardToHand(card, participant, handArea));
        ...
        async animateCardToHand(latestCardData, participant, handArea) {
          // const hand = participant.getHand();
          const displayedCardCount = handArea.children.length; // const latestCardData = hand[displayedCardCount];
...
//# sourceMappingURL=bc2822e55155ecd35a8ef1c45a750100bada5f49.js.map