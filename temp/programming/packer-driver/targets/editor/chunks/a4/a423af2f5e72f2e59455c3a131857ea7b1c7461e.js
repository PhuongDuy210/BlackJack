    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        addCardToParticipant(participant) {
          ...
          const cardToDisplay = hand.length - displayedCardCount;
          console.log(`Adding ${cardToDisplay} card(s) to ${participant instanceof (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
            error: Error()
          }), Player) : Player) ? 'Player' : 'Dealer'}`);

          for (let i = 0; i < cardToDisplay; i++) {
            this.animateCardToHand(participant, handArea);
          }
        }
        ...
        animateCardToHand(participant, handArea) {
          ...
          cardNode.setWorldPosition(this.deckPosition.getWorldPosition()); // Add to scene
          ...
          if (participant instanceof (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
            ...
            latestCardData.isFaceDown = hand.length - 1 === 0 && !participant.revealAll;
          }

          handArea.addChild(cardNode); // Animate to hand position

          const targetPos = this.getCardTargetPosition(displayedCardCount - 1);
...
//# sourceMappingURL=a423af2f5e72f2e59455c3a131857ea7b1c7461e.js.map