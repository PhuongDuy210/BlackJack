    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Prefab), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        setupChipButtons(chipEntries) {
          const spacing = 20; // space between chips

          const chipWidth = 100; // approximate width of each chip button
...
//# sourceMappingURL=e08906bb4afd02ef60c0d2a299c8b24272eb6212.js.map