  ...
  return {
    ...
    execute: function () {
      ...
      _export("DeckManager", DeckManager = (_dec = ccclass('DeckManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class DeckManager extends Component {
        ...
        loadSprites() {
          const promises = this.deck.map(card => this.loadSpriteFrame('sprites/Cards/' + card.sprite + '/spriteFrame').then(spriteFrame => {
...
//# sourceMappingURL=49eb37b975e13ff8aaf98b97ce5501ebc2752bf1.js.map