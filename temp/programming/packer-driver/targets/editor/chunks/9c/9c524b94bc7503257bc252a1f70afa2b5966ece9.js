    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && DeckManager === void 0 ? (_reportPossibleCrUseOfDeckManager({
        ...
        onAnimationFinished(participant) {
          ...
          if (this.gameState === (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), GameEvent) : GameEvent).GAME_STARTED); // Check for immediate blackjack
          ...
          if (this.gameState === (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            ...
            if (this.players[this.currentHandIndex].isBusted()) {
              if (this.currentHandIndex == this.players.length) {
                this.dealerPlay();
              } else {
        ...
        playerSplit() {
          ...
          let newHand = new (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
            error: Error()
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), GameEvent) : GameEvent).DEAL_CARD, this.players[this.currentHandIndex + 1]);
...
//# sourceMappingURL=9c524b94bc7503257bc252a1f70afa2b5966ece9.js.map