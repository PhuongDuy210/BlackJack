    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        flipDealerCards() {
          ...
          return _asyncToGenerator(function* () {
            console.log('Flipping dealer card at index:', card.name);

            for (var i = 0; i < _this3.dealerCardNodes.length; i++) {
              var cardNode = _this3.dealerCardNodes[i];

              var _card = cardNode.getComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
                error: Error()
              }), Card) : Card);

              if (_card.isFaceDown) {
                yield _card.flipCard();
              }
            }
          })();
        }
        ...
        updateCardDisplay(hand) {
          if (hand instanceof (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
            ...
            for (var i = 0; i < cardDataList.length; i++) {
              ...
              var _card2 = cardNode.addComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
                error: Error()
              }), Card) : Card);

              _card2.init(cardData);
            }
            ...
            for (var _i = 0; _i < _cardDataList.length; _i++) {
              ...
              var _card3 = _cardNode.addComponent(_crd && Card === void 0 ? (_reportPossibleCrUseOfCard({
                error: Error()
              }), Card) : Card);

              _card3.init(_cardData);
            }
          }
        }
...
//# sourceMappingURL=548edb106abd7efbd8cdb666c7e41c5211e21fad.js.map