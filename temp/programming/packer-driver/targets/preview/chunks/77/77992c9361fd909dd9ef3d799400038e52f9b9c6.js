System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Prefab, instantiate, Enum, Vec3, PoolExhaustedBehavior, Poolable, SpecialQueue, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, ObjectPool;
  ...
  function _reportPossibleCrUseOfSpecialQueue(extras) {
    _reporterNs.report("SpecialQueue", "./SpecialQueue", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SpecialQueue = _unresolved_4.SpecialQueue;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("ObjectPool", ObjectPool = (_dec = ccclass('ObjectPool'), _dec2 = property(Prefab), _dec3 = property({
        ...
        constructor() {
          ...
          this.availableNodes = [];
          this.spawnedNodes = new (_crd && SpecialQueue === void 0 ? (_reportPossibleCrUseOfSpecialQueue({
            error: Error()
        ...
        onLoad() {
          for (var i = 0; i < this.amountToPool; i++) {
            var obj = instantiate(this.objectToPool);
            var poolable = obj.getComponent(_crd && Poolable === void 0 ? (_reportPossibleCrUseOfPoolable({
              error: Error()
        ...
        pop() {
          if (this.availableNodes.length > 0) {
            var node = this.availableNodes.pop();
          ...
          switch (this.exhaustBehavior) {
            case (_crd && PoolExhaustedBehavior === void 0 ? (_reportPossibleCrUseOfPoolExhaustedBehavior({
              error: Error()
            ...
            case (_crd && PoolExhaustedBehavior === void 0 ? (_reportPossibleCrUseOfPoolExhaustedBehavior({
              error: Error()
            }), PoolExhaustedBehavior) : PoolExhaustedBehavior).Recycle:
              if (this.spawnedNodes.count > 0) {
                var oldest = this.spawnedNodes.dequeue();
            ...
            case (_crd && PoolExhaustedBehavior === void 0 ? (_reportPossibleCrUseOfPoolExhaustedBehavior({
              ...
              if (this.spawnedNodes.count < this.maxPoolSize) {
                var _obj = instantiate(this.objectToPool);

                var _poolable = _obj.getComponent(_crd && Poolable === void 0 ? (_reportPossibleCrUseOfPoolable({
                  error: Error()
                }), Poolable) : Poolable) || _obj.addComponent(_crd && Poolable === void 0 ? (_reportPossibleCrUseOfPoolable({
                  error: Error()
                }), Poolable) : Poolable);
                ...
                _obj.setParent(this.node);

                this.spawnedNodes.enqueue(_obj);
                return _obj;
              }
            ...
            case (_crd && PoolExhaustedBehavior === void 0 ? (_reportPossibleCrUseOfPoolExhaustedBehavior({
              error: Error()
            }), PoolExhaustedBehavior) : PoolExhaustedBehavior).FailSilently:
              break;
          }
...
//# sourceMappingURL=77992c9361fd909dd9ef3d799400038e52f9b9c6.js.map