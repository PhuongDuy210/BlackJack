System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, DeckManager, EventManager, GameEvent, Player, Dealer, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, GameManager;
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && DeckManager === void 0 ? (_reportPossibleCrUseOfDeckManager({
        ...
        initialDeal() {
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), GameEvent) : GameEvent).CARD_DEALED, this.player);
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            error: Error()
          }), EventManager) : EventManager).instance.gameEvents.emit((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
            error: Error()
          }), GameEvent) : GameEvent).CARD_DEALED, this.dealer); // Check for immediate blackjack
          ...
          if (this.player.hasBlackjack() || this.dealer.hasBlackjack()) {
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), GameEvent) : GameEvent).CARD_DEALED, this.dealer);
            this.endGame();
          }
        }
        ...
        determineWinner() {
          var playerValue = this.player.getHandValue();
...
//# sourceMappingURL=229424126194d6822a57b7074b7a754dbc35c730.js.map