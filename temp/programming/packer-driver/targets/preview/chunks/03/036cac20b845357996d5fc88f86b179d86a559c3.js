System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, Node, Prefab, instantiate, SpriteFrame, EventManager, GameEvent, Card, Player, Dealer, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, UIManager;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Button', 'Component', 'Node', 'Prefab', 'instantiate', 'SpriteFrame']);
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(SpriteFrame), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "playerCardContainer", _descriptor6, this);

          _initializerDefineProperty(this, "dealerCardContainer", _descriptor7, this);
        }
        ...
        updateCardDisplay(hand) {
          if (hand instanceof (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
            ...
            console.log('Updating dealer cards, revealAll =', hand.revealAll); // Update dealer card display
            ...
            for (var _i = 0; _i < _cardDataList.length; _i++) {
              var _cardData = _cardDataList[_i];
              var isFaceDown = _i === 0 && !hand.revealAll; // First card face down if not revealed

              console.log('Card', _i, ' isFaceDown =', isFaceDown);

              if (isFaceDown) {
                _cardData.spriteFrame = this.cardBackSprite;
              }
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "playerCardContainer", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "dealerCardContainer", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=036cac20b845357996d5fc88f86b179d86a559c3.js.map