    ...
    execute: function () {
      ...
      _export("Card", Card = (_dec = ccclass('Card'), _dec(_class = class Card extends Component {
        ...
        start() {
          ...
          console.log('Card component started:' + this.cardSprite);
        }
        ...
        init(cardData) {
          ...
          if (this.cardSprite) {
            console.log("Setting sprite for " + cardData.rank + " of " + cardData.suit);
...
//# sourceMappingURL=a27fc57cb6243607e61a3ea6f17ea207f6b62fa6.js.map