    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        flipDealerCards() {
          ...
          return _asyncToGenerator(function* () {
            ...
            for (var i = 0; i < dealerCardNodes.length; i++) {
              ...
              if (card.isFaceDown) {
                _this3.dealerAnimationInProgress++;
                yield card.flipCard();
        ...
        checkRemainingAnimation(participant) {
          consoloe.log('Checking remaining animations for:', participant instanceof (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
            error: Error()
...
//# sourceMappingURL=e1e35057ea689994eab59f6e13c1cf9e99f97d12.js.map