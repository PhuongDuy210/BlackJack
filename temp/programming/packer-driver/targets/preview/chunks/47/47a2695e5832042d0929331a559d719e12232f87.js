  ...
  return {
    ...
    execute: function () {
      ...
      _export("ObjectPool", ObjectPool = (_dec = ccclass('ObjectPool'), _dec2 = property(Prefab), _dec(_class = (_class2 = class ObjectPool extends Component {
        ...
        popObjectFromPool() {
          for (var i = 0; i < this.pooledObjects.length; i++) {
            var obj = this.pooledObjects[i];
          ...
          if (this.createNew) {
            ...
            this.pooledObjects.push(_obj);
            this.spawnedObjects.enqueue(_obj);
            this.amountToPool++;
            return _obj;
          }

          if (this.recycle && this.spawnedObjects.count > 0) {
            var oldest = this.spawnedObjects.dequeue();
...
//# sourceMappingURL=47a2695e5832042d0929331a559d719e12232f87.js.map