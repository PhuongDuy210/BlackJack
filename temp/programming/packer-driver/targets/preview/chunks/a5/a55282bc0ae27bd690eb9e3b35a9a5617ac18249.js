System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, Node, Prefab, instantiate, Vec3, Label, tween, Vec2, EventManager, GameEvent, Card, Player, Dealer, ChipButton, SFXID, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _descriptor16, _descriptor17, _descriptor18, _crd, ccclass, property, MAX_STACK_COUNT, MAX_STACK_PER_TYPE, UIManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Button), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(Node), _dec15 = property(Button), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Prefab), _dec19 = property(Label), _dec(_class = (_class2 = class UIManager extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "dealerScoreLabel", _descriptor12, this);

          _initializerDefineProperty(this, "dealerCardContainer", _descriptor13, this);

          _initializerDefineProperty(this, "potResetButton", _descriptor14, this);

          _initializerDefineProperty(this, "bettingArea", _descriptor15, this);

          _initializerDefineProperty(this, "potArea", _descriptor16, this);

          _initializerDefineProperty(this, "chipButtonPrefab", _descriptor17, this);

          _initializerDefineProperty(this, "totalBet", _descriptor18, this);
        ...
        addCardToParticipant(participant) {
          ...
          return _asyncToGenerator(function* () {
            ...
            for (var i = handArea.children.length; i < hand.length; i++) {
              console.log('Player Hand:' + participant.getHand()[i].rank);
        ...
        displayResult(result) {
          ...
          this.doubleButton.node.active = false;
          this.playerScoreLabels.forEach(playerScoreLabel => {
            playerScoreLabel.node.active = true;
          });
        ...
        attachPlaySFXToButton(root) {
          ...
          for (var button of buttons) {
            console.log('Attaching SFX to ' + button.node.name);
      ...
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "dealerScoreLabel", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "dealerCardContainer", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "potResetButton", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor15 = _applyDecoratedDescriptor(_class2.prototype, "bettingArea", [_dec16], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor16 = _applyDecoratedDescriptor(_class2.prototype, "potArea", [_dec17], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor17 = _applyDecoratedDescriptor(_class2.prototype, "chipButtonPrefab", [_dec18], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor18 = _applyDecoratedDescriptor(_class2.prototype, "totalBet", [_dec19], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=a55282bc0ae27bd690eb9e3b35a9a5617ac18249.js.map