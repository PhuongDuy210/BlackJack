            ...
            yield new Promise(resolve => {
              tween(cardNode).to(0.5, {
                ...
                if (!latestCardData.isFaceDown) {
                  ...
                  _this2.checkRemainingAnimation();
                }
          ...
          return _asyncToGenerator(function* () {
            ...
            for (var i = 0; i < dealerCardNodes.length; i++) {
              ...
              if (card.isFaceDown) {
                ...
                _this3.checkRemainingAnimation();
              }
            }
          })();
        }

        checkRemainingAnimation() {
          ...
          if (this.animationInProgress <= 0) {
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), GameEvent) : GameEvent).ANIMATION_FINISHED);
          }
        }
...
//# sourceMappingURL=9e2784352eef34fb23c48a59875406579f999990.js.map