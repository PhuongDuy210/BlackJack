  ...
  return {
    ...
    execute: function () {
      ...
      _export("DeckManager", DeckManager = (_dec = ccclass('DeckManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class DeckManager extends Component {
        ...
        loadSprites() {
          var promises = this.deck.map(card => this.loadSpriteFrame('sprites/Cards/' + card.sprite + '/spriteFrame').then(spriteFrame => {
...
//# sourceMappingURL=438c610427f10ae2e495e90f82cd4974c46a4e32.js.map