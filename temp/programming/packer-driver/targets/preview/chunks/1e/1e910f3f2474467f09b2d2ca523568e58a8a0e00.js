      ...
      _export("DeckManager", DeckManager = (_dec = ccclass('DeckManager'), _dec(_class = class DeckManager extends Component {
        ...
        loadSpriteFromAtlas() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.loadedCardData.forEach(card => {
            ...
            (_crd && CardAsset === void 0 ? (_reportPossibleCrUseOfCardAsset({
              error: Error()
            }), CardAsset) : CardAsset).backSpriteFrame = atlas.getSpriteFrame('BACK_1');
            _this.cardDeck = new (_crd && Deck === void 0 ? (_reportPossibleCrUseOfDeck({
              error: Error()
            }), Deck) : Deck)(_this.loadedCardData, 2);
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).instance.gameEvents.emit((_crd && GameEvent === void 0 ? (_reportPossibleCrUseOfGameEvent({
              error: Error()
...
//# sourceMappingURL=1e910f3f2474467f09b2d2ca523568e58a8a0e00.js.map