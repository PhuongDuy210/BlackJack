System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, JsonAsset, resources, Prefab, instantiate, Card, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, DeckManager;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("DeckManager", DeckManager = (_dec = ccclass('DeckManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class DeckManager extends Component {
        ...
        loadSprites() {
          resources.load('sprites/Cards/deck', JsonAsset, (err, asset) => {
            if (err) {
              console.error('Failed to load card data:', err);
              return;
            }
          ...
          //     resources.load(`sprites/Cards/${card.sprite}`, SpriteFrame, (err, spriteFrame) => {
          //         if (!err) {
...
//# sourceMappingURL=785fe14addfbaac3f5a1155f77dc5cb65ca9c1f5.js.map