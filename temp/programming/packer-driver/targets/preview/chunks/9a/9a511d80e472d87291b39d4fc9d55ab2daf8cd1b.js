System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, Node, Prefab, instantiate, EventManager, GameEvent, Card, Player, Dealer, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, UIManager;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Button', 'Component', 'Node', 'Prefab', 'instantiate']);
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(Button), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "cardPrefab", _descriptor, this);

          _initializerDefineProperty(this, "dealButton", _descriptor2, this);

          _initializerDefineProperty(this, "hitButton", _descriptor3, this);

          _initializerDefineProperty(this, "standButton", _descriptor4, this);

          _initializerDefineProperty(this, "playerCardContainer", _descriptor5, this);

          _initializerDefineProperty(this, "dealerCardContainer", _descriptor6, this);
        }
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "dealButton", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "playerCardContainer", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "dealerCardContainer", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=9a511d80e472d87291b39d4fc9d55ab2daf8cd1b.js.map