    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(_crd && DeckManager === void 0 ? (_reportPossibleCrUseOfDeckManager({
        ...
        initialDeal() {
          ...
          console.log('Dealer Hand:', this.dealer.getHand()); // EventManager.instance.gameEvents.emit(GameEvent.GAME_STARTED);
        ...
        onAnimationFinished(participant) {
          ...
          console.log('All animations finished.', this.gameState, participant instanceof (_crd && Dealer === void 0 ? (_reportPossibleCrUseOfDealer({
            error: Error()
          }), Dealer) : Dealer) ? 'Dealer' : 'Player');

          if ((this.gameState === (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
          }), GameState) : GameState).GameEnd || this.gameState === (_crd && GameState === void 0 ? (_reportPossibleCrUseOfGameState({
            error: Error()
...
//# sourceMappingURL=ee51c86af9d6473aae6ba9fd601e5fef669062ac.js.map