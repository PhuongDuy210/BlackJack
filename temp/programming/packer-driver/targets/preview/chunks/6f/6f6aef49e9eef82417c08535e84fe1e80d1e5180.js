    ...
    execute: function () {
      ...
      _export("Card", Card = (_dec = ccclass('Card'), _dec(_class = class Card extends Component {
        ...
        init(cardData) {
          ...
          console.log('Set back sprite frame ' + (_crd && CardAsset === void 0 ? (_reportPossibleCrUseOfCardAsset({
            error: Error()
          }), CardAsset) : CardAsset).backSpriteFrame.name);
        ...
        flipCard() {
          ...
          .call(() => {
            ...
            if (this.isFaceDown) {
              this.cardData.spriteFrame = (_crd && CardAsset === void 0 ? (_reportPossibleCrUseOfCardAsset({
                error: Error()
              }), CardAsset) : CardAsset).backSpriteFrame;
            } else {
...
//# sourceMappingURL=6f6aef49e9eef82417c08535e84fe1e80d1e5180.js.map