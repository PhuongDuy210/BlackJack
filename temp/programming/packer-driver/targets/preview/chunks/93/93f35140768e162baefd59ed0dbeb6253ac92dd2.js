      ...
      _export("DeckManager", DeckManager = (_dec = ccclass('DeckManager'), _dec(_class = class DeckManager extends Component {
        ...
        loadSpriteFromAtlas() {
          ...
          return _asyncToGenerator(function* () {
            ...
            (_crd && CardAsset === void 0 ? (_reportPossibleCrUseOfCardAsset({
              error: Error()
            }), CardAsset) : CardAsset).backSpriteFrame = atlas.this.cardDeck = new (_crd && Deck === void 0 ? (_reportPossibleCrUseOfDeck({
              error: Error()
...
//# sourceMappingURL=93f35140768e162baefd59ed0dbeb6253ac92dd2.js.map