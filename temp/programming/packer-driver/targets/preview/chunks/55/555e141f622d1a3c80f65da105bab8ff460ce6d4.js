System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Button, Component, Node, Prefab, instantiate, Vec3, Label, tween, UITransform, EventManager, GameEvent, Card, Player, Dealer, ChipButton, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _descriptor15, _crd, ccclass, property, UIManager;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Button', 'Component', 'Node', 'Prefab', 'instantiate', 'Vec3', 'Label', 'tween', 'UITransform']);
      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Prefab), _dec(_class = (_class2 = class UIManager extends Component {
        constructor() {
          super(...arguments);
        ...
        setupChipButtons(chipEntries) {
          var entry = chipEntries[0];
          var chipNode = instantiate(this.chipButtonPrefab);
          chipNode.setParent(this.bettingArea);
          var chipWidth = chipNode.getComponent(UITransform).width;
          var spacing = 10;
          var totalWidth = chipEntries.length * (chipWidth + spacing);
          var startX = -totalWidth / 2 + (chipWidth + spacing) / 2;
          ...
          for (var i = 1; i < chipEntries.length; i++) {
            var _entry = chipEntries[i];

            var _chipNode = instantiate(this.chipButtonPrefab);

            _chipNode.setParent(this.bettingArea);

            var _chipButton = _chipNode.getComponent(_crd && ChipButton === void 0 ? (_reportPossibleCrUseOfChipButton({
              error: Error()
            }), ChipButton) : ChipButton);

            _chipButton.setup(_entry);

            var x = startX + i * (chipWidth + spacing);

            _chipNode.setPosition(x, 0);
          }
        }

        addChip(chipEntry) {
          var _this$chipStacks$get, _this$chipStackPositi;
          ...
          chipButton.setup(chipEntry); // Get current stack count and position

          var stackCount = (_this$chipStacks$get = this.chipStacks.get(chipEntry.value)) != null ? _this$chipStacks$get : this.chipStacks.size;
          var stackPosition = (_this$chipStackPositi = this.chipStackPositions.get(chipEntry.value)) != null ? _this$chipStackPositi : this.chipStackPositions.size; // Position chip with vertical offset

          var baseX = 0; // or any fixed X position

          var baseY = 0;
          var offsetX = 50; // pixels between stacked chips

          var offsetY = 10; // pixels between stacked chips

          chipNode.setPosition(baseX + stackPosition * offsetX, baseY + stackCount * offsetY);
          this.chipStacks.set(chipEntry.value, stackCount + 1);
          this.chipStackPositions.set(chipEntry.value, stackPosition);
        }
        ...
        animateCardToHand(participant, handArea) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (participant instanceof (_crd && Player === void 0 ? (_reportPossibleCrUseOfPlayer({
              ...
              scoreLabel = _this2.playerScoreLabel;
            } else if (participant instanceof (_crd && Dealer === void 0 ? (_reportPossibleCrUseOfDealer({
              error: Error()
            }), Dealer) : Dealer)) {
...
//# sourceMappingURL=555e141f622d1a3c80f65da105bab8ff460ce6d4.js.map