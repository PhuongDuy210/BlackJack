      ...
      _export("UIManager", UIManager = (_dec = ccclass('UIManager'), _dec2 = property(Prefab), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec(_class = (_class2 = class UIManager extends Component {
        ...
        addCardToParticipant(participant) {
          ...
          return _asyncToGenerator(function* () {
            ...
            var cardsToDeal = hand.slice(handArea.children.length); // for (let i = handArea.children.length; i < hand.length; i++) {
            //     await this.animateCardToHand(participant, handArea);
            // }

            var animations = cardsToDeal.map(card => _this.animateCardToHand(card, participant, handArea));
        ...
        animateCardToHand(latestCardData, participant, handArea) {
          var _this2 = this;

          return _asyncToGenerator(function* () {
            // const hand = participant.getHand();
            var displayedCardCount = handArea.children.length; // const latestCardData = hand[displayedCardCount];
...
//# sourceMappingURL=4a95d59592833e6b970b9c1f68945cc07d01e690.js.map