System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, JsonAsset, resources, SpriteFrame, Prefab, instantiate, Card, Deck, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, DeckManager;
    ...
    execute: function () {
      ...
      _export("DeckManager", DeckManager = (_dec = ccclass('DeckManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class DeckManager extends Component {
        ...
        loadSprites() {
          ...
          Promise.all(promises).then(() => {
            ...
            this.cardDeck = new (_crd && Deck === void 0 ? (_reportPossibleCrUseOfDeck({
              error: Error()
            }), Deck) : Deck)(this.loadedCardData, 1);
            this.initCardDeck(this.cardDeck);
          }).catch(err => {
        ...
        initCardDeck(cardDeck) {
          var deckCount = cardDeck.remaining();

          for (var i = 0; i < deckCount; i++) {
            var cardData = cardDeck.peak(i);
...
//# sourceMappingURL=4a050bdbc4e457944ea9ffe5f037331feaffa801.js.map